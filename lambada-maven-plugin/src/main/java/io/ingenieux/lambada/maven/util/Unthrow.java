...
package io.ingenieux.lambada.maven.util;
...
public class Unthrow {
  ...
  public static <R, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception> Stream<R> of4(Stream<R> stream)
      throws E1, E2, E3, E4 {
    return stream;
  }
